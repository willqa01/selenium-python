...
driver.find_element(By.CLASS_NAME, "py-20").click()
time.sleep(2)
driver.find_element(By.CLASS_NAME, "glyphicon-chevron-right").click()
time.sleep(2)
#driver.find_element(By.CLASS_NAME, "ClassicNotification_module_inner_LyoqI_1711114303469").click()
#time.sleep(4)
#driver.find_element(By.CLASS_NAME, "ClassicNotification_module_closeButton_LyoqI_1711114303469").click()
#time.sleep(2)
